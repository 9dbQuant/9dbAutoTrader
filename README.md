...
**9dbAutoTrader** 是一个基于 Windows 平台的轻量级自动化股票交易助手。与传统的量化交易软件不同，它**不需要开通 QMT 或 PTrader 等高门槛交易接口**，普通券商账户即可使用。它能够接收远程交易信号，自动执行买卖操作，让个人投资者也能轻松实现自动化交易。
...
- 参考 [使用手册 - 故障排除](docs/9dbAutoTrader使用手册.md#故障排除) 章节
...
- 未正确授权或授权过期
- 账户可用资金不足
- 详见 [使用手册 - 交易问题](docs/9dbAutoTrader使用手册.md#交易问题)
...
*如有疑问，请参考完整版《[9dbAutoTrader使用手册.md](docs/9dbAutoTrader使用手册.md)》*
